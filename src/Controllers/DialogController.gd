...
@export var rolph_neutral: Texture2D
@export var rolph_scared: Texture2D
@export var douglas_neutral: Texture2D
@export var douglas_angry: Texture2D
@export var narrator: Texture2D
